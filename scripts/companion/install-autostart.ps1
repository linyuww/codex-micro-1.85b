...
if ($canRegister) {
    try {
        Register-ScheduledTask -TaskName $TaskName -Action $action -Trigger $trigger `
            ...
            -Description 'Keeps the Codex Micro board allowance in sync over BLE. Hidden background task; see scripts\companion\README.md.' `
...
Write-Host '  Logs   : ' -NoNewline; Write-Host $script:LogsDir -ForegroundColor DarkGray
Write-Host ''
