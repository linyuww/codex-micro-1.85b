...
mismatch flags a mis-paired file.
    ...
    python scripts/assets/make_icons_from_art.py            # write main/IconMask.h
    python scripts/assets/make_icons_from_art.py --sheet    # also write a verification PNG
    python scripts/assets/make_icons_from_art.py --check    # fail if out of date
"""
...
def build() -> tuple[str, dict]:
    ...
    parts = [
        "// Generated by scripts/assets/make_icons_from_art.py. Do not edit manually.\n"
        "//\n"
