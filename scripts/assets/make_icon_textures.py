...
RGB565 is stored big-endian, matching the panel's byte order.
    ...
    python scripts/assets/make_icon_textures.py            # write main/IconTextures.h
    python scripts/assets/make_icon_textures.py --sheet    # also write a preview PNG
    python scripts/assets/make_icon_textures.py --check    # fail if out of date
    python scripts/assets/make_icon_textures.py --from render
"""
...
def emit(icons) -> str:
    parts = [
        "// Generated by scripts/assets/make_icon_textures.py. Do not edit manually.\n"
        "//\n"
