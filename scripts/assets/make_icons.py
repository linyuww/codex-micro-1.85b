...
every status colour and every fade level.
    ...
    python scripts/assets/make_icons.py            # write main/IconMask.h
    python scripts/assets/make_icons.py --check    # fail if out of date (CI)
    python scripts/assets/make_icons.py --sheet    # also write outputs/icon-sheet.png
"""
...
def build() -> str:
    parts = [
        "// Generated by scripts/assets/make_icons.py. Do not edit manually.\n"
        "//\n"
