...
.DESCRIPTION
    ...
    see README 6.13 and companion\README.md.
...
# ---------------------------------------------------------------- power policy
Write-Section 'Power policy (README 6.14)'
...
# ---------------------------------------------------------------- radio toggle
Write-Section 'Bluetooth radio (README 6.16: wedged host stack)'
if ($ToggleRadio) {
...
# ---------------------------------------------------------------- pairing
Write-Section 'Host-side bond (README 6.16)'
if ($RepairPairing) {
    if (-not $address) {
