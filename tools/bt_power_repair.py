...
`--apply`; `--restore` puts the previous values back.
    ...
    python tools/bt_power_repair.py              # report only
    python tools/bt_power_repair.py --apply      # needs Administrator
    python tools/bt_power_repair.py --restore    # needs Administrator
"""
