...
Usage:
    ...
    python tools/bt_reconnect.py --address 28:84:85:B2:1C:73
    python tools/bt_reconnect.py --address 28:84:85:B2:1C:73 --loop --interval 30
...
def main() -> int:
    ...
    print(
        ...
        "failing, reset the host stack with tools/bt_radio_toggle.py".format(
