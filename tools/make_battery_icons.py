...
charging icons where the bolt crosses the fill boundary.
    ...
    python tools/make_battery_icons.py            # write main/BatteryIcons.h
    python tools/make_battery_icons.py --sheet    # also write outputs/battery_icons.png
    python tools/make_battery_icons.py --check    # fail if out of date (CI)
...
def build() -> tuple[str, str, dict]:
    ...
    parts = [
        "// Generated by tools/make_battery_icons.py. Do not edit manually.\n"
        "//\n"
    ...
    py_parts = [
        "# Auto-generated by tools/make_battery_icons.py. Do not edit.\n"
...
def main() -> int:
    ...
    parser.add_argument("--py-output", type=Path,
                        default=root / "tools" / "battery_icon_data.py")
