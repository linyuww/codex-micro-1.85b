...
Usage:
    python tools/hid_rpc.py --method sys.version
    python tools/hid_rpc.py --method device.status
    python tools/hid_rpc.py --method v.oai.rgbcfg --params '{"keys":{"effect":0}}'
    python tools/hid_rpc.py --listen 10          # just read reports for 10 s
"""
